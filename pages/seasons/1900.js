    ...
    return (
      <>
        ...
        <main className="min-h-screen bg-white text-blue-950 p-6 space-y-12">
          <h1 className="text-4xl font-bold text-pink-500 mb-2 text-center">1900 Season Preview</h1>
        ...
        <li key={team} className={`${teamColors[team]} p-4 rounded-xl shadow`}>
          <div className="flex items-center justify-between mb-1">
            <h3 className="text-xl font-semibold flex items-center gap-2">
              <a href={`/constructors/${team.toLowerCase()}`} className="text-blue-800 hover:underline">{team}</a>
              {code && (
                <img
                  src={`https://flagcdn.com/w40/${code}.png`}
                  alt={country}
